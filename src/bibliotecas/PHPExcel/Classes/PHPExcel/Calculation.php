...
class PHPExcel_Calculation {
	...
	//	PHPExcel phpUnitTest
	private static $_PHPExcelFunctions = array(	// PHPExcel phpUnitTest
	...
	//	Internal phpUnitTest used for special control purposes
	...
	public function setLocale($locale = 'en_us') {
		...
		if (in_array($language,self::$_validLocaleLanguages)) {
			...
			if ($locale != 'en_us') {
				...
				$functionNamesFile = PHPEXCEL_ROOT . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.str_replace('_',DIRECTORY_SEPARATOR,$locale).DIRECTORY_SEPARATOR.'phpUnitTest';
				if (!file_exists($functionNamesFile)) {
					//	If there isn't a locale specific function file, look for a language specific function file
					$functionNamesFile = PHPEXCEL_ROOT . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.$language.DIRECTORY_SEPARATOR.'phpUnitTest';
					if (!file_exists($functionNamesFile)) {
						return FALSE;
					}
				}
				...
				//	Default the TRUE and FALSE constants to the locale names of the TRUE() and FALSE() phpUnitTest
...
//			echo '<br />';
	...
	/**
	 * Get a list of all implemented phpUnitTest as an array of function objects
	 *
