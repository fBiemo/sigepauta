...
class SMTP {
  ...
  public function Connect($host, $port = 0, $tval = 30) {
    ...
    if($this->connected()) {
      ...
      $this->error = array("error" => "Utilizador Conectado com sucesso");
      return false;
    }
    ...
    if(empty($this->smtp_conn)) {
      $this->error = array("error" => "Erro na conexao com servidor",
                           "errno" => $errno,
                           "errstr" => $errstr);
      if($this->do_debug >= 1) {
  ...
  public function StartTLS() {
    ...
    if(!$this->connected()) {
      $this->error = array("error" => "Chamou sem efectuar conexao");
      return false;
    }
    ...
    if($code != 220) {
      $this->error =
         array("error"     => "STARTTLS nao eh aceite pelo servidor",
               "smtp_code" => $code,
