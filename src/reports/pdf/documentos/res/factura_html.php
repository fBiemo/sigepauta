...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "infoss.net@yahoo.com "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
       ...
       <br>
        ...
        <tr>
		  ...
		  <td style="width:25%;" class='midnight-blue'>DATA</td>
		   <td style="width:40%;" class='midnight-blue'>FORMA DE PAGAMENTO</td>
        </tr>
		<tr>
           <td style="width:35%;">
			<?php 
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        <tr>
            <th style="width: 10%;text-align:center" class='midnight-blue'>QUANT.</th>
            <th style="width: 60%" class='midnight-blue'>DESCRIÇÃO</th>
            <th style="width: 15%;text-align: right" class='midnight-blue'>PREÇO UNIT.</th>
            <th style="width: 15%;text-align: right" class='midnight-blue'>PREÇO TOTAL</th>
...
?>
	...
	<br>
	<div style="font-size:11pt;text-align:center;font-weight:bold">Docuemnto Processado por Computador,<br> Obrigado pela sua preferencia</div>
