        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "INFOSS.NET, E.I"; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
...
?>
	...
	<br>
	<div style="font-size:11pt;text-align:center;font-weight:bold">Documento Processado por Computador, <br> Obrigado Pela Preferencia!</div>
