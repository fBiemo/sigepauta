...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_testIsDeprecated = false;       // test the deprecated phpUnitTest
        ...
        protected $_subHEADER        = array();     // sub action to make the bibliotecas
        ...
        /**
         * Set the test on deprecated phpUnitTest
         *
         * @access public
         * @param  boolean  $mode
         * @return HTML2PDF $this
...
'.$content.'
        ...
        /**
         * draw the PDF bibliotecas with the HTML in page_header
         *
         * @access protected
         */
