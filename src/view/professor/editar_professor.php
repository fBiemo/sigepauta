		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
				<label for="user_name2" class="col-sm-3 control-label">Regime</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
                ...
                <div class="form-group">
                    <label for="lastname2" class="col-sm-3 control-label">Sexo</label>
                    <div class="col-sm-8">

                        <select name="user_sexo" id="user_sexo" class="form-control">

                            <?php
                            $rs = mysqli_query($con, 'SELECT * FROM sexo');
                            while ($row = mysqli_fetch_assoc($rs)){ ?>

                                <option value="<?php echo $row['idsexo']?>"><?php echo $row['descricao'] ?></option>
