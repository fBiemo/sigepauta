  ...
  <body>
    ...
    <div class="container">
		...
		<div class="panel-heading">
			...
			<?php
			include("form_professor.php");
			include("editar_professor.php");
			include("docente_disciplina.php");
			?>
	...
	?>
	<script type="text/javascript" src="../fragments/js/professor.js"></script>
